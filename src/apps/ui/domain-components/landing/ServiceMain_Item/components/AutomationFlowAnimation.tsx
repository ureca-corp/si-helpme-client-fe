...
export const AutomationFlowAnimation = () => {
  return (
    <div className="flex items-center justify-center gap-1">
      {/* 문서 아이콘 */}
      <motion.div
        className="flex items-center justify-center rounded-md bg-teal-500 p-3 text-2xl"
        initial={{ scale: 1 }}
        animate={{
      ...
      {/* 로봇 아이콘 */}
      <motion.div
        className="flex items-center justify-center rounded-md bg-pink-500 p-3 text-2xl"
        initial={{ scale: 1 }}
        animate={{
